...
plot(1:size(real_energy,1), reactive_energy);
 axis([1 size(real_energy,1) -100 250]);
set(gca,...
'Units','normalized',...
'YTick',-100:50:250,...
'XTick',0:30:360,...
...
% 
% 
% %print(aluminum_scada,'aluminum_scada.pdf','-dpdf','-r0');
 print(aluminum_scada,'aluminum_scada.png', '-dpng', '-r0');
