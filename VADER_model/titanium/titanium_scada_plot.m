...
plot(1:size(real_energy,1), reactive_energy);
 axis([1 size(real_energy,1) -300 300]);
set(gca,...
'Units','normalized',...
'YTick',-300:50:300,...
'XTick',0:30:360,...
...
% 
% 
% %print(titanium_scada,'titanium_scada.pdf','-dpdf','-r0');
 print(titanium_scada,'titanium_scada.png', '-dpng', '-r0');
